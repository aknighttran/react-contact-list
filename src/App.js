...
class App extends Component {
  state = { 
    contacts: [
      { id: 1, firstName: 'Bob', phone: '111-111-1111'},
      { id: 2, firstName: 'Jerry', phone: '222-222-2222'},
      { id: 3, firstName: 'Cosmo', phone: '333-333-3333'}
    ],
    showForm: true,
  }
  ...
  updateContact = (contactData, id) => {
    // remove the contact and replace it with the new one... only allow to update once!
